...
static CraftingRecepie recepies[] =
{
	...
	// v0.7 early metallurgy progression recovered from the shipped executable.
	// Each supported overworld log can be fired directly into charcoal.
	recepie<1>(Item(ItemTypes::charcoal, 2), {Item(BlockTypes::woodLog, 1)}).setRequiresFurnace(),
	recepie<1>(Item(ItemTypes::charcoal, 2), {Item(BlockTypes::spruce_log, 1)}).setRequiresFurnace(),
	recepie<1>(Item(ItemTypes::charcoal, 2), {Item(BlockTypes::birch_log, 1)}).setRequiresFurnace(),
	recepie<1>(Item(ItemTypes::charcoal, 2), {Item(BlockTypes::jungle_log, 1)}).setRequiresFurnace(),
	...
	// v0.7 bronze tools
	recepie<2>(Item(ItemTypes::bronzePickaxe, 1), {Item(ItemTypes::bronzeIngot, 4), Item(BlockTypes::wooden_plank, 3)}).setAnyWood().setRequiresWorkBench(),
	recepie<2>(Item(ItemTypes::bronzeAxe, 1), {Item(ItemTypes::bronzeIngot, 3), Item(BlockTypes::wooden_plank, 3)}).setAnyWood().setRequiresWorkBench(),
	recepie<2>(Item(ItemTypes::bronzeShovel, 1), {Item(ItemTypes::bronzeIngot, 3), Item(BlockTypes::wooden_plank, 3)}).setAnyWood().setRequiresWorkBench(),
	...
	recepie<2>(Item(ItemTypes::bronzeSword, 1), {Item(ItemTypes::bronzeIngot, 4), Item(ItemTypes::stick, 1)}).setRequiresWorkBench(),
